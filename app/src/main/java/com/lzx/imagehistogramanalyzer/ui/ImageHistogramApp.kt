...
fun ImageHistogramApp(
    ...
    ImageHistogramContent(
        ...
        onCameraAdjustmentControllerChanged = cameraViewModel::setAdjustmentController,
        ...
        onDecreaseExposure = cameraViewModel::decreaseExposure,
        onIncreaseExposure = cameraViewModel::increaseExposure,
        onToggleTorch = cameraViewModel::toggleTorch,
        onApplySuggestedAdjustment = cameraViewModel::applySuggestedAdjustment,
...
internal fun ImageHistogramContent(
    ...
    onCameraAdjustmentControllerChanged: (com.lzx.imagehistogramanalyzer.domain.camera.CameraAdjustmentController?) -> Unit,
