...
- 单元测试、Compose 仪器测试、Lint、Debug 构建和 API 36 模拟器主流程已通过。性能卡片已拆分取像素、灰度转换/融合统计、频次统计、归一化和其他开销；首轮单线程热循环优化已完成并保持全部 RGB 结果一致，等待 Xiaomi 14 对 12.58MP 图片复测后决定内存与多线程优化顺序。
